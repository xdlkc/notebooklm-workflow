# 我不想让 AI 替我读书，于是做了一个“AI 书童”

> 用 Hermes Agent + NotebookLM 跑完《罪与罚》之后，我发现自动化读书最难的不是“总结”。

![AI 书童头图：阅读不是被替代，而是多了一个帮你整理书桌的 Agent](assets/ai-book-attendant/hero-ai-book-attendant-detailed.png)
...
![Workflow 流水线](assets/ai-book-attendant/workflow-pipeline.png)

![更细的 workflow 桌面图：source、Q&A、Studio、QA、Drive 都在同一张工作台上](assets/ai-book-attendant/detailed-workflow-desk.png)

![NotebookLM Workflow 架构图：从 source ready 到 manifest/checksum](assets/ai-book-attendant/workflow-architecture-map.png)
...
![AI 书童吉祥物](assets/ai-book-attendant/ai-book-attendant-mascot.png)
...
![《罪与罚》PPT 20 页预览](assets/ai-book-attendant/zuiyufa-ppt-contact-sheet.png)
...
![PPT 封面页](assets/ai-book-attendant/zuiyufa-slide-01.png)

人物关系页把拉斯柯尔尼科夫、索尼娅、杜尼娅、拉祖米欣、波尔菲里、斯维德里盖洛夫放到同一张图里。对小说来说，这比一段摘要有用得多。

![PPT 人物关系页](assets/ai-book-attendant/zuiyufa-slide-03.png)

中间的主题页会继续展开犯罪理论、心理崩塌、审讯、忏悔和救赎。它不是“读后感”，更像把小说拆成一组可以讲的模块。

![PPT 主题页示例](assets/ai-book-attendant/zuiyufa-slide-08.png)
...
<video controls width="100%" src="../demos/zuiyufa/drive_outputs/crime_and_punishment_video.mp4">
  你的阅读器不支持内嵌视频，可以直接打开：../demos/zuiyufa/drive_outputs/crime_and_punishment_video.mp4
</video>

信息图是另一种表达形式。它适合快速复盘，不适合承载太多解释，所以最终版本被我压缩成更稳定的短文案和固定模块。

![NotebookLM 最终信息图](../demos/zuiyufa/drive_outputs/crime_and_punishment_infographic_final_minimal.png)

这些真实产物都在 demo 目录里：

```text
demos/zuiyufa/ppt_previews/ppt_contact_sheet.html
demos/zuiyufa/drive_outputs/crime_and_punishment_slide_deck.pptx
demos/zuiyufa/drive_outputs/crime_and_punishment_slide_deck.pdf
demos/zuiyufa/drive_outputs/crime_and_punishment_infographic_final_minimal.png
demos/zuiyufa/drive_outputs/crime_and_punishment_video.mp4
```
...
![读书素材矩阵](assets/ai-book-attendant/artifact-matrix.png)

![更细的素材矩阵：理解材料、展示材料、交付记录三类资产](assets/ai-book-attendant/artifact-matrix-detailed.png)
...
![Hermes Agent 驱动 NotebookLM 的问题链条：问题、回答、结构化素材、Studio 产物](assets/ai-book-attendant/question-chain-notebooklm.png)
...
![质量闸门](assets/ai-book-attendant/quality-gate.png)

![更细的 QA 闸门：失败、重试、缩短文案、最终通过](assets/ai-book-attendant/quality-gate-detailed.png)
...
![真实 workflow 会留下的脏细节：日志、timeout、retry、validation summary](assets/ai-book-attendant/messy-validation-details.png)
...
![适合谁、不适合谁：读书博主、读书会、老师、研究者，以及不适合一键偷懒的人](assets/ai-book-attendant/audience-fit-not-fit.png)
...
![结尾图：AI 书童把材料收拾好，真正判断和表达仍然属于读书的人](assets/ai-book-attendant/closing-clean-desk.png)
